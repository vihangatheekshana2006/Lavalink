...
const downloadLatestLavalink = async () => {
  const lavalinkReleases = "https://api.github.com/repos/lavalink-devs/Lavalink/releases";
  ...
  try {
    ...
    if (latestRelease) {
      ...
      response.data.on("data", (chunk) => {
        ...
        // Safer output for environments that don't support clearLine or cursorTo
        process.stdout.write(`\rDownloading... ${formatBytes(downloadedSize)} / ${formatBytes(totalSize)} (${percent.toFixed(2)}%)`);
      });
